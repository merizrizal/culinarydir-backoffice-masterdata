...
use core\models\search\ProvinceSearch;
 ...
 */
class ProvinceController extends \backoffice\controllers\BaseController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionDelete($id)
    {
        ...
        $return['url'] = Yii::$app->urlManager->createUrl([$this->module->id . '/province/index']);
