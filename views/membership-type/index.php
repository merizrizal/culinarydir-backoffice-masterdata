...
<div class="membership-type-index">
    ...
    <?= GridView::widget([
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
            return ['id' => $model['id'], 'class' => 'row-grid-view-membership-type', 'style' => 'cursor: pointer;'];
        },
        'pager' => [
...
$jscript = ''
    ...
    $("div.container.body").on("click", function(event) {
        ...
        if ($(event.target).parent(".row-grid-view-membership-type").length > 0) {
    ...
    $(".row-grid-view-membership-type").popover({
        trigger: "click",
        placement: "top",
        container: ".row-grid-view-membership-type",
        html: true,
        selector: "td",
        content: function () {
    ...
    $(".row-grid-view-membership-type").on("shown.bs.popover", function(event) {
