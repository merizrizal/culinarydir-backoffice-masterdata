...
/* @var $searchModel core\models\search\DistrictSearch */
...
<div class="district-index">
    ...
    <?= GridView::widget([
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
            return ['id' => $model['id'], 'class' => 'row-grid-view-district', 'style' => 'cursor: pointer;'];
        },
        'pager' => [
...
$jscript = ''
    ...
    $("div.container.body").on("click", function(event) {
        ...
        if ($(event.target).parent(".row-grid-view-district").length > 0) {
    ...
    $(".row-grid-view-district").popover({
        trigger: "click",
        placement: "top",
        container: ".row-grid-view-district",
        html: true,
        selector: "td",
        content: function () {
    ...
    $(".row-grid-view-district").on("shown.bs.popover", function(event) {
