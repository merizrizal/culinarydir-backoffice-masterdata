...
/* @var $searchModel core\models\search\CategorySearch */
...
$this->title = Yii::t('app', 'Business Category');
...
<div class="category-index">
    ...
    <?= GridView::widget([
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
            return ['id' => $model['id'], 'class' => 'row-grid-view-category', 'style' => 'cursor: pointer;'];
        },
        'pager' => [
...
$jscript = ''
    ...
    $("div.container.body").on("click", function(event) {
        ...
        if ($(event.target).parent(".row-grid-view-category").length > 0) {
    ...
    $(".row-grid-view-category").popover({
        trigger: "click",
        placement: "top",
        container: ".row-grid-view-category",
        html: true,
        selector: "td",
        content: function () {
    ...
    $(".row-grid-view-category").on("shown.bs.popover", function(event) {
