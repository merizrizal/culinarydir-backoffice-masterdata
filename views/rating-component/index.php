...
$this->title = Yii::t('app', 'Rating Component');
$this->params['breadcrumbs'][] = $this->title; ?>

<?= $ajaxRequest->component(true) ?>

<div class="rating-component-index">
    ...
    <?= GridView::widget([
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
            return ['id' => $model['id'], 'class' => 'row-grid-view-rating-component', 'style' => 'cursor: pointer;'];
        },
        'pager' => [
...
$jscript = ''
    ...
    $("div.container.body").on("click", function(event) {
        ...
        if ($(event.target).parent(".row-grid-view-rating-component").length > 0) {
    ...
    $(".row-grid-view-rating-component").popover({
        trigger: "click",
        placement: "top",
        container: ".row-grid-view-rating-component",
        html: true,
        selector: "td",
        content: function () {
    ...
    $(".row-grid-view-rating-component").on("shown.bs.popover", function(event) {
