...
/* @var $searchModel backend\models\search\FacilitySearch */
...
<div class="facility-index">
    ...
    <?= GridView::widget([
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
            return ['id' => $model['id'], 'class' => 'row-grid-view-facility', 'style' => 'cursor: pointer;'];
        },
        'pager' => [
...
$jscript = ''
    ...
    $("div.container.body").on("click", function(event) {
        ...
        if ($(event.target).parent(".row-grid-view-facility").length > 0) {
    ...
    $(".row-grid-view-facility").popover({
        trigger: "click",
        placement: "top",
        container: ".row-grid-view-facility",
        html: true,
        selector: "td",
        content: function () {
    ...
    $(".row-grid-view-facility").on("shown.bs.popover", function(event) {
