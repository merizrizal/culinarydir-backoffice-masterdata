...
/* @var $searchModel core\models\search\CitySearch */
...
<div class="city-index">
    ...
    <?= GridView::widget([
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
            return ['id' => $model['id'], 'class' => 'row-grid-view-city', 'style' => 'cursor: pointer;'];
        },
        'pager' => [
...
$jscript = ''
    ...
    $("div.container.body").on("click", function(event) {
        ...
        if ($(event.target).parent(".row-grid-view-city").length > 0) {
    ...
    $(".row-grid-view-city").popover({
        trigger: "click",
        placement: "top",
        container: ".row-grid-view-city",
        html: true,
        selector: "td",
        content: function () {
    ...
    $(".row-grid-view-city").on("shown.bs.popover", function(event) {
