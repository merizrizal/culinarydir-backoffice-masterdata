...
/* @var $searchModel backend\models\search\VillageSearch */
...
<div class="village-index">
    ...
    <?= GridView::widget([
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
            return ['id' => $model['id'], 'class' => 'row-grid-view-village', 'style' => 'cursor: pointer;'];
        },
        'pager' => [
...
$jscript = ''
    ...
    $("div.container.body").on("click", function(event) {
        ...
        if ($(event.target).parent(".row-grid-view-village").length > 0) {
    ...
    $(".row-grid-view-village").popover({
        trigger: "click",
        placement: "top",
        container: ".row-grid-view-village",
        html: true,
        selector: "td",
        content: function () {
    ...
    $(".row-grid-view-village").on("shown.bs.popover", function(event) {
